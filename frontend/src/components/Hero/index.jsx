      ...
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 py-8 max-w-full overflow-hidden">
          ...
          <TypingAnimation
            ...
            className="font-bold p-2 text-4xl sm:text-6xl md:text-7xl text-mainColor glow"
          />
          ...
          <TypingAnimation
            ...
            className="text-xl md:text-2xl font-bold pb-6 text-gray-300 glow"
          />

          {/* Buttons */}
          <div className="block mt-4">
            <button className="button button-main mr-2" onClick={onStart}>
              Start Translating
            </button>
            <button className="button button-main" onClick={onStartVideoChat}>
              Video Translation
            </button>
          </div>
        </div>
